...
//  Darts Scoreboard
//
//  Created by Dirk Hostens on 16/09/2022.
//
...
class DartsUtil {
    ...
    func getDoublesToFinish(score: Int) -> [String] {
        switch (score) {
            ...
            case 138 : return ["T20", "T14", "D18"]
            case 137 : return ["T17", "T18", "D16"]
            case 136 : return ["T20", "T20", "D8"]
            case 135 : return ["T20", "T15", "D15"]
            case 134 : return ["T20", "T14", "D16"]
            case 133 : return ["T20", "T19", "D8"]
            case 132 : return ["T20", "T20", "D6"]
            case 131 : return ["T20", "T13", "D16"]
            case 130 : return ["T20", "T18", "D8"]
            case 129 : return ["T19", "T20", "D6"]
            case 128 : return ["T18", "T14", "D16"]
            case 127 : return ["T19", "T18", "D8"]
            case 126 : return ["T19", "T19", "D6"]
            case 125 : return ["Bull", "T20", "D20"]
            case 124 : return ["T20", "D16", "D16"]
            case 123 : return ["T19", "T16", "D9"]
            case 122 : return ["T18", "T20", "D4"]
            case 121 : return ["T20", "T15", "D8"]
            case 120 : return ["T20", "20", "D20"]
            case 119 : return ["T19", "T10", "D10"]
